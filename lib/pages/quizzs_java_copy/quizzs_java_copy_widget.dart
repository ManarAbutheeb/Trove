...
import 'quizzs_java_copy_model.dart';
export 'quizzs_java_copy_model.dart';

class QuizzsJavaCopyWidget extends StatefulWidget {
  const QuizzsJavaCopyWidget({
    super.key,
    this.quizRef,
  ...
  @override
  State<QuizzsJavaCopyWidget> createState() => _QuizzsJavaCopyWidgetState();
}

class _QuizzsJavaCopyWidgetState extends State<QuizzsJavaCopyWidget> {
  late QuizzsJavaCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => QuizzsJavaCopyModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<int>(
      ...
      builder: (context, snapshot) {
        ...
        int quizzsJavaCopyCount = snapshot.data!;
                                                        ...
                                                        child: StreamBuilder<
                                                          ...
                                                          builder: (context,
                                                            ...
                                                            return QuizOptionWidget(
                                                              key: Key(
                                                                  'Keyy2z_${pageViewIndex}_of_${pageViewQuizzesRecordList.length}'),
                                                              questionNum: 'A',
                                                              questionName:
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: StreamBuilder<
                                                          ...
                                                          builder: (context,
                                                            ...
                                                            return QuizOptionWidget(
                                                              key: Key(
                                                                  'Key9wi_${pageViewIndex}_of_${pageViewQuizzesRecordList.length}'),
                                                              questionNum: 'B',
                                                              questionName:
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: StreamBuilder<
                                                          ...
                                                          builder: (context,
                                                            ...
                                                            return QuizOptionWidget(
                                                              key: Key(
                                                                  'Keyk1q_${pageViewIndex}_of_${pageViewQuizzesRecordList.length}'),
                                                              questionNum: 'C',
                                                              questionName:
