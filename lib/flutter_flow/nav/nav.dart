...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'CyberSecurity',
          path: '/CyberSecurity',
          builder: (context, params) => CyberSecurityWidget(
            quiz: params.getParam<DocumentReference>(
              'quiz',
              ParamType.DocumentReference,
              isList: true,
        ...
        FFRoute(
          ...
          builder: (context, params) => FlashCardsWidget(
            javaRefernce: params.getParam(
              'javaRefernce',
              ParamType.DocumentReference,
              isList: false,
              collectionNamePath: ['ProgLanguages'],
            ),
          ),
        ),
        FFRoute(
        ...
        FFRoute(
          name: 'javaCopy',
          path: '/javaCopy',
          builder: (context, params) => JavaCopyWidget(
            duration: params.getParam(
              'duration',
              ParamType.int,
            ),
        ...
        FFRoute(
          name: 'QuizzesPageWriteCopy',
          path: '/quizzesPageWriteCopy',
          builder: (context, params) => QuizzesPageWriteCopyWidget(
            frontText: params.getParam(
              'frontText',
              ParamType.String,
            ),
          ),
        ...
        FFRoute(
          name: 'QuizzesPageWriteCopyCopy',
          path: '/quizzesPageWriteCopyCopy',
          builder: (context, params) => const QuizzesPageWriteCopyCopyWidget(),
        ),
        FFRoute(
          name: 'javaCopyCopy',
          path: '/javaCopyCopy',
          builder: (context, params) => JavaCopyCopyWidget(
            duration: params.getParam(
              'duration',
              ParamType.int,
            ),
        ...
        FFRoute(
          name: 'javaCopyCopyCopy',
          path: '/javaCopyCopyCopy',
          builder: (context, params) => JavaCopyCopyCopyWidget(
            duration: params.getParam(
              'duration',
              ParamType.int,
            ),
        ...
        FFRoute(
          name: 'FlashCardsCopy',
          path: '/flashCardsCopy',
          builder: (context, params) => FlashCardsCopyWidget(
            pythonRef: params.getParam(
              'pythonRef',
              ParamType.DocumentReference,
              isList: false,
              collectionNamePath: ['PythonQ'],
            ),
          ),
        ),
        FFRoute(
          name: 'FlashCardsCopyCopy',
          path: '/flashCardsCopyCopy',
          builder: (context, params) => FlashCardsCopyCopyWidget(
            csRef: params.getParam(
              'csRef',
              ParamType.DocumentReference,
              isList: false,
              collectionNamePath: ['CSQ'],
            ),
          ),
        )
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Image.asset(
                    'assets/images/Trove_Artboard_1.jpg',
                    fit: BoxFit.contain,
                  ),
                )
              : page;
