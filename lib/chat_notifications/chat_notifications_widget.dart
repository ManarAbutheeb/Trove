...
class _ChatNotificationsWidgetState extends State<ChatNotificationsWidget> {
  ...
  void initState() {
    ...
    _model.inputNewPostTextController ??= TextEditingController();
                            ...
                            Expanded(
                              child: Padding(
                                ...
                                child: SizedBox(
                                  ...
                                  child: TextFormField(
                                    controller:
                                        _model.inputNewPostTextController,
                                    ...
                                    validator: _model
                                        .inputNewPostTextControllerValidator
                                        .asValidator(context),
                                  ),
                                ),
                              ),
                                ...
                                child: FlutterFlowIconButton(
                                  ...
                                  onPressed: () async {
                                    await PostsRecord.createDoc(widget.topicid!)
                                      ...
                                      text: _model
                                          .inputNewPostTextController.text,
