...
import 'schema/python_q_record.dart';
import 'schema/flash_cards2_record.dart';
import 'schema/csq_record.dart';
import 'schema/flash_cards3_record.dart';
...
export 'schema/python_q_record.dart';
export 'schema/flash_cards2_record.dart';
export 'schema/csq_record.dart';
export 'schema/flash_cards3_record.dart';
...
/// Functions to query PythonQRecords (as a Stream and as a Future).
Future<int> queryPythonQRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      PythonQRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<PythonQRecord>> queryPythonQRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      PythonQRecord.collection,
      PythonQRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<PythonQRecord>> queryPythonQRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query FlashCards2Records (as a Stream and as a Future).
Future<int> queryFlashCards2RecordCount({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      FlashCards2Record.collection(parent),
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<FlashCards2Record>> queryFlashCards2Record({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
    ...
    queryCollection(
      FlashCards2Record.collection(parent),
      FlashCards2Record.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<FlashCards2Record>> queryFlashCards2RecordOnce({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
...
/// Functions to query CsqRecords (as a Stream and as a Future).
Future<int> queryCsqRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      CsqRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<CsqRecord>> queryCsqRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      CsqRecord.collection,
      CsqRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<CsqRecord>> queryCsqRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query FlashCards3Records (as a Stream and as a Future).
Future<int> queryFlashCards3RecordCount({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      FlashCards3Record.collection(parent),
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<FlashCards3Record>> queryFlashCards3Record({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
    ...
    queryCollection(
      FlashCards3Record.collection(parent),
      FlashCards3Record.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<FlashCards3Record>> queryFlashCards3RecordOnce({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
